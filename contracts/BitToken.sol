...
contract BitToken is StandardToken, Controlled {
    
    using SafeMath for uint;

    string public constant name = "BitFuel";

    string public constant symbol = "BFUEL";
    ...
    // for token circulation on platforms that integrate Bit before unlockTime
    mapping (address => bool) internal precirculated;

    function BitToken(uint _unlockTime) public {
