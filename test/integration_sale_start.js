...
contract('BitToken', function(accounts) {
    ...
    it ("Integration test: public sale", function() {
        ...
        return bit_token.balanceOf(bitlab_reserve_addr)
            .then(function(res) {
                bit_reserve_token_balance_before_invest = res;
                console.log('Token balance of bit reserve account before invest is ' + bit_reserve_token_balance_before_invest.toString(10));
            ...
            .then (function(res) {
                bit_reserve_token_balance_after_invest = res;
                console.log('Token balance of bit reserve account after invest is ' + bit_reserve_token_balance_after_invest);
                target_bit_reserve_token_balance_delta = public_sale_amount.times(exchange_rate).times(60).div(40);
                assert.equal(bit_reserve_token_balance_after_invest.minus(bit_reserve_token_balance_before_invest).equals(target_bit_reserve_token_balance_delta), true, 'incorrect bit reserve token balance');
    ...
    it ("Integration test: end sale", function() {
        console.log('----------------');
        return bit_token_sale.saleFinalized.call()
            .then(function(res) {
                ...
                console.log('Current blocknumber is :' + web3.eth.blockNumber);
                return bit_token_sale.finalizeSale({from: root_addr, gas:4700000});
            })
            .then(function() {
                return bit_token_sale.saleFinalized.call();
            })
    ...
    it ("Integration test: transfer after unlock", function() {
        ...
        return bit_token.getUnlockTime()
            .then(function(res) {
                ...
                console.log('Current blocknumber is :' + web3.eth.blockNumber);
                return bit_token.balanceOf(token_recepient_address);
            })
            .then(function(res) {
            ...
            .then(function(res) {
                ...
                return bit_token.transfer(token_recepient_address, token_transfer_amount, {from: public_sale_addr, gas: 4700000});
            })
            .then(function() {
