...
contract('TimelockedSafeTest', function(accounts) {
    ...
    var widthdraw_addr = bitlab_reserve_addr;
    ...
    it ("TimelockedSafe test: deploy", function() {
        ...
        return BitToken.deployed()
            ...
            .then(function(tls) {
                timelocked_safe = tls;
                timelocked_safe.changeTokenAddress(bit_token.address, {from: admin_addr, gas:4700000});
    ...
    it ("TimelockedSafe test: send tokens to the timelocked safe", function() {
        ...
        return bit_token.balanceOf(timelocked_safe.address)
            .then(function(bal) {
                bal0 = bal;
                console.log('Initial Bit token balance of timelocked safe ' + timelocked_safe + ' is ' + bal0);
                return bit_token.transfer(timelocked_safe.address, safe_initial_balance, {from: bitlab_reserve_addr, gas:4700000});
            })
            .then(function() {
                return bit_token.balanceOf(timelocked_safe.address);
            })
            .then(function(bal) {
                bal1 = bal;
                console.log('Bit token balance of timelocked safe after the first transfer is ' + bal1);
    ...
    it ("TimelockedSafe test: Withdraw tokens in the first vesting month", function() {
        ...
        return bit_token.balanceOf(timelocked_safe.address)
            .then(function(bal) {
                ...
                console.log('Bit token balance of timelocked safe  ' + timelocked_safe.address + ' is ' + safe_bal0);
                return bit_token.balanceOf(widthdraw_addr);
            })
            .then(function(bal) {
                withdraw_bal0 = new web3.BigNumber(bal);
                console.log('Bit token balance of withdraw address ' + widthdraw_addr + ' is ' + withdraw_bal0);
                console.log('>>>>> Withdraw ' + withdraw_amount_in_wei_1 + ' wei Bit tokens...')
           ...
           .then(function(res) {
            ...
            .then(function(bal) {
                ...
                console.log('Bit token balance of timelocked safe  ' + timelocked_safe.address + ' is ' + safe_bal1);
                return bit_token.balanceOf(widthdraw_addr);
            })
            .then(function(bal) {
                withdraw_bal1 = new web3.BigNumber(bal);
                console.log('Bit token balance of withdraw address ' + widthdraw_addr + ' is ' + withdraw_bal1);
                ...
                console.log('>>>>> Withdraw ' + withdraw_amount_in_wei_2 + ' wei Bit tokens...')
           ...
           .then(function(res) {
            ...
            .then(function(bal) {
                ...
                console.log('Bit token balance of timelocked safe  ' + timelocked_safe.address + ' is ' + safe_bal2);
                return bit_token.balanceOf(widthdraw_addr);
            })
            .then(function(bal) {
                withdraw_bal2 = new web3.BigNumber(bal);
                console.log('Bit token balance of withdraw address ' + widthdraw_addr + ' is ' + withdraw_bal2);
                ...
                console.log('>>>>> Attempt to withdraw ' + withdraw_amount_in_wei_3 + ' wei Bit tokens...')
    ...
    it ("TimelockedSafe test: Withdraw tokens in the second vesting month", function() {
        ...
        return timelocked_safe.startTime.call()
            ...
            .then(function(bal) {
                withdraw_bal0 = new web3.BigNumber(bal);
                console.log('Bit token balance of withdraw address ' + widthdraw_addr + ' is ' + withdraw_bal0);
                console.log('>>>>> Withdraw ' + second_month_withdraw_amount_in_wei + ' wei Bit tokens...')
    ...
    it ("TimelockedSafe test: one year locking with finalized config", function() {
        ...
        return timelocked_safe.changeLockingPeriod(locking_period_in_months, {from: admin_addr, gas:4700000})
            ...
            .then(function() {
                console.log('>>>>> Attempt to withdraw ' + withdraw_amount_in_wei + ' Wei Bit tokens...');
            ...
            .then(function(bal) {
                withdraw_bal0 = new web3.BigNumber(bal);
                console.log('Bit token balance of withdraw address ' + widthdraw_addr + ' is ' + withdraw_bal0);
                console.log('>>>>> Withdraw ' + one_time_withdraw_amount_in_wei + ' Wei Bit tokens...');
