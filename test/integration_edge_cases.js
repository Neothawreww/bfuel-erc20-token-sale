...
contract('BitToken', function(accounts) {
    ...
    var bitlab_reserve_addr = accounts[4];
    ...
    it ("Integration test: set exchange rate", function() {
        console.log('----------------');
        return bit_token_sale.setExchangeRate(exchange_rate, {from: exchange_rate_controller, gas: 4700000})
            .then(function() {
                return bit_token_sale.exchangeRate.call()
            })
            .then(function(rate) {
    ...
    it ("Integration test: set start and end time of sale", function() {
        console.log('----------------');
        return bit_token_sale.setStartTimeOfSale(sale_start_block, {from: admin_addr, gas:4700000})
            .then(function() {
                return bit_token_sale.setEndTimeOfSale(sale_end_block, {from: admin_addr, gas:4700000})
            })
            .then(function() {
                return bit_token_sale.initialBlock.call()
            })
            .then(function(res) {
                console.log('Sale starts at: ' + res);
                return bit_token_sale.finalBlock.call()
            })
            .then(function(res) {
    ...
    it ("Integration test: set unlock time", function() {
        console.log('----------------');
        return bit_token_sale.changeUnlockTime(unlock_time, {from: admin_addr, gas:4700000})
            .then(function() {
    ...
    it ("Integration test: presale", function() {
        console.log('----------------');
        return bit_token_sale.allocatePresaleTokens(presale_addr, presale_amount, {from: admin_addr, gas:4700000})
            .then(function() {
                return bit_token.balanceOf(presale_addr);
            })
            .then(function(res) {
                console.log('Balance of presale account ' + presale_addr + ' is ' + res)
                return bit_token.balanceOf(bitlab_reserve_addr);
            })
            .then(function(res) {
                console.log('Balance of bitLab reserve account ' + bitlab_reserve_addr + ' is ' + res)
            })
    });

    it ("Integration test: allow precirculation on bitlab_reserve_addr, sliver_integration_addr and streamer_addr", function() {
        console.log('----------------');
        console.log('allowing precirculation for bitlab_reserve_addr: ' + bitlab_reserve_addr);
        return bit_token_sale.allowPrecirculation(bitlab_reserve_addr, {from: admin_addr, gas:4700000})
            .then(function() {
                console.log('allowing precirculation for sliver_integration_addr: ' + sliver_integration_addr)
                return bit_token_sale.allowPrecirculation(sliver_integration_addr, {from: admin_addr, gas:4700000})
            })
            .then(function() {
                console.log('allowing precirculation for streamer_addr: ' + streamer_addr)
                return bit_token_sale.allowPrecirculation(streamer_addr, {from: admin_addr, gas: 4700000})
            })
            .then(function() {
                console.log('done.')          
            })
    ...
    it ("Integration test: transfer from bitlab_reserve_addr to sliver_integration_addr", function() {
        console.log('----------------');
        console.log('Before transfer:');
        return bit_token.balanceOf(bitlab_reserve_addr)
            .then(function(res) {
                console.log('Bit reserve balance: ' + res);
                return bit_token.balanceOf(sliver_integration_addr);
            })
            .then(function(res) {
                console.log('Sliver integration account balance: ' + res)
                console.log('Transfering ' + precirculation_amount + ' from bitlab_reserve_addr ' + bitlab_reserve_addr + ' to sliver_integration_addr ' + sliver_integration_addr);
                return bit_token.transfer(sliver_integration_addr, precirculation_amount, {from: bitlab_reserve_addr, gas: 4700000});
            })
            .then(function(res) {
    ...
    it ("Integration test: remove bitlab_reserve_addr from precirculation", function() {
        console.log('----------------');
        return bit_token_sale.disallowPrecirculation(bitlab_reserve_addr, {from: admin_addr, gas: 4700000})
            .then(function() {
                return bit_token_sale.isPrecirculationAllowed(bitlab_reserve_addr, {from: admin_addr, gas: 4700000});
            })
            .then(function(res) {
                console.log('is precirculation allowed for bitlab_reserve_addr ' + bitlab_reserve_addr + ' ? ' + res);
            })
    });

    it ("Integration test: add whitelist public_sale_addr and presale_addr", function() {
        console.log('----------------');
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr, presale_addr], {from: whitelist_controller, gas:4700000})
            .then(function() {
                return bit_token_sale.isWhitelisted(public_sale_addr);
            })
            .then(function(res) {
                console.log('Is public_sale_addr ' + public_sale_addr + ' whitelisted? ' + res);
                return bit_token_sale.isWhitelisted(presale_addr);
            })
            .then(function(res) {
    ...
    it ("Integration test: token purchase before sale starts", function() {
        ...
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
        	.then(function() {
        		return bit_token.balanceOf(public_sale_addr);
        	})
        	.then(function(bit_balance) {
        		public_sale_addr_init_bit_balance = bit_balance;
        		public_sale_addr_init_eth_balance = web3.eth.getBalance(public_sale_addr);
        		console.log('public sale purchaser Bit balance: ' + public_sale_addr_init_bit_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
        		console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitTokenSale...');
        		web3.eth.sendTransaction({from: public_sale_addr, to: bit_token_sale.address, value: purchase_eth, gas: 4700000});
            })
        	.catch(function() {
        	...
        	.then(function(bit_balance) {
        		public_sale_addr_final_bit_balance = bit_balance;
        		public_sale_addr_final_eth_balance = web3.eth.getBalance(public_sale_addr);
        		console.log('public sale purchaser Bit balance: ' + public_sale_addr_final_bit_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
        		assert(public_sale_addr_final_bit_balance.equals(public_sale_addr_init_bit_balance), 'should not change!');
            })
    });
    ...
    it ("Integration test: special account balance checks #3", function() {
        ...
        return bit_token.totalSupply()
            ...
            .then(function(bitlab_balance) {
                bitlab_reserve_balance = new web3.BigNumber(bitlab_balance);
                ...
                console.log('Bit Labs reserve balance  : ' + bitlab_reserve_balance);
                console.log('pre-circulation total amount: ' + precirculation_amount);

                console.log('reserve ratio: ' + bitlab_reserve_balance.plus(precirculation_amount).dividedBy(current_supply));

                assert(current_supply.times(0.6).minus(bitlab_reserve_balance).minus(precirc_amount) < +EPSILON,  'invalid bitlab_reserve_balance ratio');
                assert(current_supply.times(0.6).minus(bitlab_reserve_balance).minus(precirc_amount) > -EPSILON, 'invalid bitlab_reserve_balance ratio');                
            })
    });
    ...
    it ("Integration test: token purchase after sale starts", function() {
        ...
        assert(web3.eth.blockNumber > sale_start_block);
       	...
       	purchase_eth = new web3.BigNumber(1 * Math.pow(10,18));
        return bit_token_sale.activateSale({from: admin_addr, gas: 4700000})
            .then(function() {
                return bit_token_sale.changeTokenSaleHardCap(presale_amount.plus(purchase_eth.times(exchange_rate).times(10000)));
            })
            .then(function() {
                return bit_token_sale.changeFundCollectedHardCap(purchase_eth.times(10000));
            })
        	.then(function() {
        		return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000});	
        	})
        	...
        	.then(function(bit_balance) {
        		public_sale_addr_init_bit_balance = new web3.BigNumber(bit_balance);
        		public_sale_addr_init_eth_balance = new web3.BigNumber(web3.eth.getBalance(public_sale_addr));
        		console.log('public sale purchaser Bit balance: ' + public_sale_addr_init_bit_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
        		console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitTokenSale...');
        		tx_hash = web3.eth.sendTransaction({from: public_sale_addr, to: bit_token_sale.address, value: purchase_eth, gas: 4700000});
        	...
        	.then(function(bit_balance) {
        		public_sale_addr_final_bit_balance = new web3.BigNumber(bit_balance);
        		public_sale_addr_final_eth_balance = new web3.BigNumber(web3.eth.getBalance(public_sale_addr));
        		console.log('public sale purchaser Bit balance: ' + public_sale_addr_final_bit_balance.toString());
        		console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
        		assert(public_sale_addr_final_bit_balance.minus(public_sale_addr_init_bit_balance).equals(purchase_eth * exchange_rate), 'should decrease!');
    ...
    it ("Integration test: token purchase from non-whitelisted addresses after sale starts", function() {
        ...
        purchase_eth = new web3.BigNumber(1 * Math.pow(10,18));
        return bit_token_sale.deleteAccountsFromWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            .then(function() {
                return bit_token.balanceOf(public_sale_addr);
            })
            .then(function(bit_balance) {
                ...
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_init_eth_balance.toString());
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitTokenSale...');
                return web3.eth.sendTransaction({from: public_sale_addr, to: bit_token_sale.address, value: purchase_eth, gas: 4700000});
            })
            .catch(function() {
            ...
            .then(function(bit_balance) {
                ...
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_final_bit_balance.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
                assert(public_sale_addr_final_bit_balance.equals(public_sale_addr_init_bit_balance), 'should decrease!');
    ...
    it ("Integration test: token purchase with less than minially required ETH", function() {
        ...
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(bit_balance) {
                ...
                return bit_token_sale.changeMinimalPayment(purchase_eth, {from: admin_addr});
            })
            .then(function() {
                return bit_token.balanceOf(public_sale_addr);
            })
            ...
            .then(function(bit_balance) {
                ...
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_final_bit_balance.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_final_eth_balance.toString());
                assert(public_sale_addr_final_bit_balance.equals(public_sale_addr_init_bit_balance.plus(purchase_eth * exchange_rate)), 'should increase by purchased amount!');
                assert(public_sale_addr_init_eth_balance.greaterThan(public_sale_addr_final_eth_balance), 'should cost some gas!');
                console.log('Changing minimal payment back to 1 ether')
                return bit_token_sale.changeMinimalPayment(1000000000000000000, {from: admin_addr});
            })
            .then(function() {
                return bit_token_sale.minimalPayment.call();
            })
    ...
    it ("Integration test: token purchase when sold token count approaches the hard cap", function() {
        ...
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(supply) {
                ...
                return bit_token_sale.changeTokenSaleHardCap(new_token_sale_hard_cap);
            })
            .then(function() {
                return bit_token_sale.tokenSaleHardCap.call();
            })
            .then(function(token_hard_cap) {
                ...
                return bit_token_sale.changeFundCollectedHardCap(new_fund_collected_hard_cap);
            })
            .then(function() {
                return bit_token_sale.fundCollectedHardCap.call();
            })
            ...
            .then(function(bit_balance) {
                public_sale_addr_bit_balance_1 = bit_balance;
                public_sale_addr_eth_balance_1 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_bit_balance_1.minus(public_sale_addr_init_bit_balance).equals(purchase_eth.times(exchange_rate)), 'should increase!');
            ...
            .then(function(supply) {
                ...
                return bit_token_sale.getFundCollected({from: admin_addr, gas: 4700000});
            })
            ...
            .then(function(bit_balance) {
                public_sale_addr_bit_balance_2 = bit_balance;
                public_sale_addr_eth_balance_2 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_2.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_2.toString());
                assert.equal(public_sale_addr_bit_balance_2 - public_sale_addr_bit_balance_1, 0, 'should not change!');
    ...
    it ("Integration test: token purchase when total fund collected approaches the hard cap", function() {
        ...
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(fund_collected) {
                ...
                return bit_token_sale.changeFundCollectedHardCap(new_fund_collected_hard_cap, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return bit_token_sale.fundCollectedHardCap.call();
            })
            ...
            .then(function() {
                ...
                return bit_token_sale.changeTokenSaleHardCap(new_token_sale_hard_cap, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return bit_token_sale.tokenSaleHardCap.call();
            })
            ...
            .then(function(bit_balance) {
                ...
                //             Number(public_sale_addr_eth_balance_1) + Number(purchase_eth) + Number(tx_gas_used), 'ETH balance should decrease by the expected amount!');                return bit_token.totalSupply();
                return bit_token.totalSupply();
            })
            .then(function(supply) {
                current_supply = Number(supply);
            ...
            .then(function(bit_balance) {
                ...
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_2.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_2.toString());
                assert(public_sale_addr_bit_balance_2.equals(public_sale_addr_bit_balance_1), 'should not change!');
                assert(public_sale_addr_eth_balance_1.greaterThan(public_sale_addr_eth_balance_2), 'should cost some gas!');
                return bit_token.totalSupply();
            })
            .then(function(supply) {
    ...
    it ("Integration test: emergency sale stop/restart", function() {
        ...
        return bit_token_sale.addAccountsToWhitelist([public_sale_addr], {from: whitelist_controller, gas: 4700000})
            ...
            .then(function(bit_balance) {
                ...
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_bit_balance_1.minus(public_sale_addr_init_bit_balance).equals(purchase_eth * exchange_rate), 'should increase!');
                assert(public_sale_addr_init_eth_balance.greaterThan(public_sale_addr_eth_balance_1.plus(purchase_eth)), 'should decrease!');
                return bit_token_sale.emergencyStopSale({from: admin_addr, gas: 4700000});
            })
            .then(function() {
                console.log('');
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitTokenSale...');
            ...
            .then(function(bit_balance) {
                ...
                assert(public_sale_addr_bit_balance_2.equals(public_sale_addr_bit_balance_1), 'should not change!');
                assert(public_sale_addr_eth_balance_1.greaterThan(public_sale_addr_eth_balance_2), 'should cost some gas!');
                return bit_token_sale.restartSale({from: admin_addr, gas: 4700000});
            })
            .then(function() {
                console.log('');
                console.log('>>> public sale purchaser sending ' + purchase_eth + ' wei (ETH) to BitTokenSale...');
            ...
            .then(function(bit_balance) {
                public_sale_addr_bit_balance_3 = bit_balance;
                public_sale_addr_eth_balance_3 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_3.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_3.toString());
                assert(public_sale_addr_bit_balance_3.minus(public_sale_addr_bit_balance_2).equals(purchase_eth.times(exchange_rate)), 'should increase!');
    ...
    it ("Integration test: token transfer() before unlockTime", function() {
        ...
        return bit_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            .then(function() {
            ...
            .then(function(balance) {
                ...
                return bit_token.transfer(precirculation_allowed_addr, transfer_amount_1, {from: presale_addr, gas: 4700000})
            })
            .then(function() {
                return bit_token.balanceOf(presale_addr);
            })
            ...
            .then(function() {
                ...
                return bit_token.transfer(presale_addr, transfer_amount_2, {from: precirculation_allowed_addr, gas: 4700000});
            })
            .catch(function() {
            ...
            .then(function(balance) {
                ...
                return bit_token.transfer(precirculation_disallowed_addr, transfer_amount_1, {from: presale_addr, gas: 4700000})
            })
            .catch(function() {
    ...
    it ("Integration test: token transferFrom() before unlockTime", function() {
        ...
        return bit_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                ...
                return bit_token.approve(transfer_operator, allowance_amount, {from: presale_addr, gas: 4700000});
            })
            .then(function() {
                return bit_token.allowance(presale_addr, transfer_operator);
            })
            ...
            .then(function(balance) {
                ...
                return bit_token.transferFrom(presale_addr, precirculation_allowed_addr, transfer_amount_1, 
            ...
            .then(function(balance) {
                ...
                return bit_token.transferFrom(presale_addr, precirculation_allowed_addr, transfer_amount_2, 
                    {from: transfer_operator, gas: 4700000});
            })
            .then(function() {
                return bit_token.allowance(presale_addr, transfer_operator);
            ...
            .then(function(balance) {
                ...
                return bit_token.transferFrom(presale_addr, precirculation_disallowed_addr, transfer_amount_3, 
                    {from: transfer_operator, gas: 4700000});
            })
            .catch(function() {
    ...
    it ("Integration test: attempt to purchase tokens after token sale ends", function() {
        ...
        return bit_token.totalSupply()
            ...
            .then(function(bit_balance) {
                public_sale_addr_bit_balance_1 = new web3.BigNumber(bit_balance);
                public_sale_addr_eth_balance_1 = web3.eth.getBalance(public_sale_addr);
                console.log('public sale purchaser Bit balance: ' + public_sale_addr_bit_balance_1.toString());
                console.log('public sale purchaser ETH balance: ' + public_sale_addr_eth_balance_1.toString());
                assert(public_sale_addr_bit_balance_1.equals(public_sale_addr_init_bit_balance), 'should not change!');
    ...
    it ("Integration test: token transfer() after unlockTime", function() {
        ...
        return bit_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                return bit_token_sale.disallowPrecirculation(precirculation_disallowed_addr, {from: admin_addr, gas: 4700000});
            })
            .then(function() {
                return bit_token.balanceOf(presale_addr);
            })
    ...
    it ("Integration test: token transferFrom() after unlockTime", function() {
        ...
        return bit_token_sale.allowPrecirculation(presale_addr, {from: admin_addr, gas: 4700000})
            ...
            .then(function() {
                return bit_token.approve(transfer_operator, 0, {from: presale_addr, gas: 4700000});
            })
            .then(function() {
                console.log('approving allowance: ' + allowance_amount.toString());
                return bit_token.approve(transfer_operator, allowance_amount, {from: presale_addr, gas: 4700000});
